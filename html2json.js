...
/*
  Converts an HTML string into a JSON tree without using DOMParser, document,
  innerHTML, or third-party HTML parser libraries.
    ...
    children: [
      {
        type: "element",
        tag: "div",
        attributes: { class: "example", disabled: true },
        children: [
...
function html2json(htmlText) {
  const input = typeof htmlText === "string" ? htmlText : String(htmlText ?? "");
